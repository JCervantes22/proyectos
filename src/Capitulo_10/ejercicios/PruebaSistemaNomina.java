...
public class PruebaSistemaNomina {
    public static void main(String[] args) {
        ...
        TrabajadorPorPiezas empleadoPorPieza = new TrabajadorPorPiezas("Pedro", "Gomez", "555-55-5555", 2.5, 100);
        ...
        System.out.printf("%s%n%s: $%,.2f%n%n",
                empleadoPorPieza, "ingresos", empleadoPorPieza.ingresos());
